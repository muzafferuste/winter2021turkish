...
public class Scope1 {
	...
	// static variable'lar class level'da olusturuldugu icin class'in her yerinden
	// kullanilabilirler
	// instance variable'lar static olmayan method'larda direk kullanilabiliyorken,
	// static method'larda
	// object olusturularak kullanilabiliyordu
	// static variable'lar ise ister static isterse static olamayan tum
	// method'lardan direk kullanilabilir
