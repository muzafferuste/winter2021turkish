...
public class C1_Set01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(set1); // [A, B, C, T, D, F, Y, Z]

        System.out.println(set1.hashCode());// 599

        System.out.println(set1); // [A, B, R, C, T, D, F, Y, Z]
        ...
        */
        ...
        System.out.println(set1.hashCode());// 681
        ...
        elemanlarin ASCII table'dan gelen degerler toplamini verir
         */
